    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <div className="bg-cyan-500 p-8 rounded-lg shadow-lg flex items-center justify-center col-span-1 h-[200px]" style={{ backgroundColor: '#a8ba86' }}>
            
            <AccionesMejorRendimiento/>

          </div>
          <div className="bg-lime-500 p-8 rounded-lg shadow-lg flex items-center justify-center col-span-1 h-[200px]" style={{ backgroundColor: '#a8ba86' }}>
